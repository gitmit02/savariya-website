...
// const HeroSection = () => {
//   return (
//     <div className="relative h-screen bg-cover bg-center bg-no-repeat" style={{backgroundImage: 'url(/hero.jpg)'}}>
//       {/* Overlay */}
...
//               <Link
//                 to="/collection"
//                 className="group inline-flex items-center px-8 py-4 bg-golden text-brown-900 font-semibold rounded-full hover:bg-yellow-400 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
//               >
...
//               <Link
//                 to="/contact"
//                 className="group inline-flex items-center px-8 py-4 border-2 border-golden text-golden font-semibold rounded-full hover:bg-golden hover:text-brown-900 transform hover:scale-105 transition-all duration-300"
//               >
...
//                 <div className="text-golden text-2xl mb-2">✨</div>
//                 <h3 className="text-white font-semibold text-lg">Custom Fitting</h3>
//                 <p className="text-gray-300 text-sm">Perfect tailoring for your body</p>
//               </div>
//               <div className="bg-black bg-opacity-30 backdrop-blur-sm p-6 rounded-lg">
//                 <div className="text-golden text-2xl mb-2">🎯</div>
//                 <h3 className="text-white font-semibold text-lg">Timely Delivery</h3>
//                 <p className="text-gray-300 text-sm">Ready when you need it</p>
//               </div>
//               <div className="bg-black bg-opacity-30 backdrop-blur-sm p-6 rounded-lg">
//                 <div className="text-golden text-2xl mb-2">👔</div>
//                 <h3 className="text-white font-semibold text-lg">Premium Quality</h3>
//                 <p className="text-gray-300 text-sm">Finest fabrics and craftsmanship</p>
//               </div>
//             </div>
//           </div>
//         </div>
        ...
        <div className="text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
          <div className="fade-in-up"> 
            <h1 className="font-heading text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
              <span className="text-golden">Savariya</span>
              <br />
              <span className="text-2xl sm:text-5xl">Premium Groom Wear</span>
            </h1>
